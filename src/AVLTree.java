...
////        testTree.insertBST(50);
////        testTree.insertBST(66);
////        for(int i=0;i<5;i++){
////            int ran = (int)(Math.random() * 100);
////            System.out.print(ran+" ");
////            testTree.insertBST(ran);
////        }
////        System.out.println ();
...
//////        testTree.deleteElement ( 50 );
//////        testTree.deleteElement ( 66 );
//////        System.out.println ();
//////        testTree.InOrderTraverse ( testTree.root );
////    }
////
...
////     *
////     */
////    private void fixAfterDeletion(BiTNode p){
...
////
////    /**
////     * 根据输入的元素查找其在平衡二叉树中对应的结点
////     * @param e 要查找的元素
////     * @return 对应的结点，查找失败返回null
////     */
////    public BiTNode getBiTNode(int e){
////        BiTNode tmp = root;
////        while (tmp != null) {
////            if (e == tmp.data) {
////                return tmp;
...
////     */
////    static BiTNode successor(BiTNode t) {
////        if (t == null)
////            return null;
////        else if (t.rChild != null) { //往右，然后向左直到尽头
////            BiTNode p = t.rChild;
////            while (p.lChild != null)
////                p = p.lChild;
////            return p;
...
////            BiTNode p = t.parent;
////            BiTNode ch = t;
////            while (p != null && ch == p.rChild) {    //如果t是p的右子树，则继续向上搜索其直接后继
////                ch = p;
////                p = p.parent;
////            }
////            return p;
...
////        return false;
////    }
////    public void deleteBST(BiTNode p){
////        size --;
...
////                root = replacement;
////            else if (p == p.parent.lChild)    //如果p是左孩子
////                p.parent.lChild  = replacement;
////            else                            //如果p是右孩子
////                p.parent.rChild = replacement;
////
////            p.lChild = p.rChild = p.parent = null;     //p的指针清空
////
...
////     *
////     */
////    public boolean insertBST(int element) {
////        BiTNode t = root;
////        if (t == null) {
////            root = new BiTNode ( element, null );
////            size = 0;
////            return true;
////        }
////        BiTNode parent;     //用于保存t的父结点
////        //从根节点向下搜索，找到插入位置
////        do {
////            parent = t;
////            if (t != null && element < t.data) {
////                t = t.lChild;
////            } else if (t != null && element > t.data) {
////                t = t.rChild;
////            } else {
////                return false;
////            }
////        } while (t != null);
////
////        BiTNode child = new BiTNode ( element, parent );
////        if (t != null && element < t.data)
////            parent.lChild = child;
////        else
////            parent.rChild = child;
...
////     * 至于调整之后，各节点的BF变化见代码
////     */
////    private void fixAfterInsertion(BiTNode p){
////        if(p.bf == 2){
////            leftBalance(p);
////        }
////        if(p.bf == -2){
...
////
////        }
////        public BiTNode(int data,BiTNode parent){
////            this.data = data;
////            this.lChild = null;
////            this.rChild = null;
////            this.parent = parent;
...
public class AVLTree<E> {
     ...
     * 前序遍历算法
     */
    public void PreOrderTraverse(Entry<E> node) {
        if (node == null){
            return;
        }
     ...
     * 中序遍历算法
     */
    public void InOrderTraverse(Entry<E> node) {
        if (node == null){
            return;
        }
     ...
     * 后序遍历算法
     */
    public void PostOrderTraverse(Entry<E> node) {
        if (node == null){
            return;
        }
